...
class BasePlugin:
    ...
    def onHeartbeat(self):
        ...
        if self.runInterval <= 0:
            ...
            L3_Current = self.rs485.read_float(0x000A, functioncode=4, numberOfRegisters=2)
            L1_Active_Power = self.rs485.read_float(0x000C, functioncode=4, numberOfRegisters=2)
            L2_Active_Power = self.rs485.read_float(0x000E, functioncode=4, numberOfRegisters=2)
            L3_Active_Power = self.rs485.read_float(0x0010, functioncode=4, numberOfRegisters=2)
